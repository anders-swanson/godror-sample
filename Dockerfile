...
LABEL org.opencontainers.image.authors="Anders Swanson."
LABEL org.opencontainers.image.description="godror sample"
...
COPY --from=build /go/src/godror-sample/godror-sample /godror-sample

USER 1000

ENTRYPOINT ["/godror-sample"]
